...
namespace Flynt\Components\BlockInterviewHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockInterviewHeader', function ($data) {
    $data['dateFormat'] = get_option('date_format');
    return $data;
});

Options::addTranslatable('BlockInterviewHeader', [
    [
