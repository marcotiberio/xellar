...
namespace Flynt\Components\BlockArtistHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockArtistHeader', function ($data) {
    $data['dateFormat'] = get_option('date_format');
    return $data;
});

Options::addTranslatable('BlockArtistHeader', [
    [
