...
namespace Flynt\Components\ListingCovers;
...
add_filter('Flynt/addComponentData?name=ListingCovers', function ($data) {
    $postType = POST_TYPE;
...
Options::addTranslatable('ListingCovers', [
    [
