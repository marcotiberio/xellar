...
namespace Flynt\Components\ListingPastEvents;
...
add_filter('Flynt/addComponentData?name=ListingPastEvents', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'ListingPastEvents',
        'label' => __('Listing: Past Events', 'flynt'),
        'sub_fields' => [
            [
...
Options::addTranslatable('ListingPastEvents', [
    [
